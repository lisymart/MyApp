 ...
 * Original file: C:\\Users\\Anthoni\\workspace\\MyApp\\src\\cz\\muni\\fi\\myapp\\Fusion.aidl
 */
package cz.muni.fi.myapp;
public interface Fusion extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cz.muni.fi.myapp.Fusion
{
private static final java.lang.String DESCRIPTOR = "cz.muni.fi.myapp.Fusion";
...
/**
 * Cast an IBinder object into an cz.muni.fi.myapp.Fusion interface,
 * generating a proxy if needed.
 */
public static cz.muni.fi.myapp.Fusion asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cz.muni.fi.myapp.Fusion))) {
return ((cz.muni.fi.myapp.Fusion)iin);
}
return new cz.muni.fi.myapp.Fusion.Stub.Proxy(obj);
}
...
private static class Proxy implements cz.muni.fi.myapp.Fusion
{
