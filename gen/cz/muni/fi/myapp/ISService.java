 ...
 * Original file: C:\\Users\\Anthoni\\workspace\\MyApp\\src\\cz\\muni\\fi\\myapp\\ISService.aidl
 */
package cz.muni.fi.myapp;
public interface ISService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cz.muni.fi.myapp.ISService
{
private static final java.lang.String DESCRIPTOR = "cz.muni.fi.myapp.ISService";
...
/**
 * Cast an IBinder object into an cz.muni.fi.myapp.ISService interface,
 * generating a proxy if needed.
 */
public static cz.muni.fi.myapp.ISService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cz.muni.fi.myapp.ISService))) {
return ((cz.muni.fi.myapp.ISService)iin);
}
return new cz.muni.fi.myapp.ISService.Stub.Proxy(obj);
}
...
private static class Proxy implements cz.muni.fi.myapp.ISService
{
