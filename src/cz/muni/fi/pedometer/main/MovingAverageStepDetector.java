...
import cz.muni.fi.pedometer.filters.CumulativeSignalPowerTD;
import cz.muni.fi.pedometer.filters.MovingAverageTD;
...
public class MovingAverageStepDetector extends StepDetector {
		...
		public float processAccelerometerValues(long timestamp, float[] values) {
                ...
                stepDetected = false;
                boolean newSwapState = maValues[1] > maValues[2] && maValues[1]>STEP_LIMIT;  //hranica, kedy bude krok zaznamenaný
